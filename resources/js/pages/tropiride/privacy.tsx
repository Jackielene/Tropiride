    ...
    content: [
      {
        ...
        text: "When you create an account or make a booking, we collect personal information such as your name, email address, phone number, and profile image. This information is necessary to process your bookings and provide customer support."
      },
      {
        subtitle: "Booking Information",
        text: "We collect information related to your ride requests, including pickup and drop-off locations, dates, times, fare estimates, and payment details. This information is used to fulfill your transportation requests."
      },
      {
        subtitle: "Usage Data",
        text: "We automatically collect information about how you interact with our website, including IP address, browser type, pages visited, and time spent on pages. This helps us improve our services and user experience."
      },
    ]
  },
  {
    ...
    content: [
      {
        ...
        text: "We use your information to process bookings, connect you with drivers, process payments, and communicate about your rides."
      },
      {
        subtitle: "Account Management",
        text: "Your information helps us manage your account, maintain your booking history, and provide personalized recommendations."
      },
      {
        subtitle: "Communication",
        text: "We may send you booking confirmations, ride updates, important service notifications, and customer support communications."
      },
      {
        subtitle: "Improvement",
        text: "We analyze usage data to improve our services, develop new features, and enhance the safety and reliability of our platform."
      },
    ]
  },
  {
    ...
    content: [
      {
        ...
        text: "We implement industry-standard security measures including encryption, secure servers, and regular security audits to protect your personal information from unauthorized access, alteration, or disclosure."
      },
      {
        subtitle: "Data Retention",
        text: "We retain your personal information for as long as necessary to provide our services and comply with legal obligations. Booking records are typically kept for 7 years as required by Philippine law."
      },
      {
        subtitle: "Third-Party Services",
        text: "We work with trusted third-party service providers for payment processing and cloud storage. These partners are contractually obligated to protect your information."
      },
    ]
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: "You may request deletion of your account and personal data. However, we may retain certain information as required by law or for legitimate business purposes."
      },
      {
        subtitle: "Opt-Out",
        text: "You can opt-out of marketing communications at any time by updating your preferences in your account settings or clicking unsubscribe in our emails."
      },
    ]
  },
  {
    ...
    content: [
      {
        ...
        text: "We use cookies and similar technologies to enhance your browsing experience, analyze site traffic, and remember your preferences. You can control cookies through your browser settings."
      },
      {
        subtitle: "Analytics",
        text: "We use analytics tools to understand how visitors use our website, which helps us improve our services and user experience."
      },
    ]
  },
  {
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl p-8 border-2 border-cyan-100">
                ...
                <p className="text-gray-700 leading-relaxed">
                  At Tropiride, we are committed to protecting your privacy and ensuring the security of your personal information. 
                  This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our 
                  vehicle rental and transportation services in Siargao, Philippines.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="text-3xl font-black mb-4">Questions About Privacy?</h3>
